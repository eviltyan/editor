...
<video src="https://github.com/user-attachments/assets/29a12645-0bf2-443d-94e9-5cc205afe79b" width="320" height="240" controls></video>  
  
## 2. Интерфейс с вкладками, позволяющий одновременно работать с несколькими текстами (для окна редактирования).  
<video src="https://github.com/user-attachments/assets/8e45070f-9bf0-4304-a2f8-319f370d0c94" width="320" height="240" controls></video>  
  
## 3. Выбор языка интерфейса приложения (интернационализация).  
<video src="https://github.com/user-attachments/assets/a79767c4-eb9d-4090-bafd-1b37dd0dd2b5" width="320" height="240" controls></video>  
...
<video src="https://github.com/user-attachments/assets/64427634-35fa-40f1-bdcf-b5386c5d134b" height="240" controls></video>  
...
1. В случае, если парсер находится после открывающей скобки, то есть в списке параметров и ожидался следующий параметр или окончание списка параметров, то парсер будет отбрасывать все токены до тех пор, пока не найдет запятую (",") или закрывающую скобку (")").  
...
2. В случае, если парсер находится в любом другом состоянии, то парсер будет отбрасывать все токены до тех пор, пока не найдет один из следующих токенов: "<-", "(", ";", ")", ",", искомые токены зависят от момента, на котором произошла ошибка.
Использование автоматной грамматики позволяет точно определить набор токенов, на которые парсер может ориентироваться:
1) В состоянии написания идентификатора: "<-", "(", ";", ")", ","  
2) В состоянии ожидания оператора присваивания: "(", ";", ")", ","  
3) В состоянии ожидания идентификатора - функции или NULL: "(", ";", ")", ","  
4) После вызова функции при ождиании "(": ";", ")", ","  
5) Внутри списка параметров при ожидании ")" или после списка параметров при ожидании ",": ";", ")", ","  
6) В состоянии ожидания ";": ";"  
